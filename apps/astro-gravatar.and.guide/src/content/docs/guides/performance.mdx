...
<CardGrid>
  <Card title="Cache Aggressively" icon="database">
    <p style="margin: 0;">Use built-in caching and avoid repeated API calls for the same user data.</p>
  </Card>
  ...
  <Card title="Use Appropriate Sizes" icon="ruler">
    <p style="margin: 0;">Don't use unnecessarily large avatar sizes. Stick to 32-200px for optimal performance.</p>
  </Card>
