---
title: Installation
description: Install astro-gravatar in an Astro 4-6 project and render your first avatar in minutes.
---
...
- [CLI Guide](/guides/cli) - Generate URLs from the terminal
