...
description: Browse props, defaults, and usage patterns for GravatarAvatar, GravatarProfileCard, and GravatarQR.
---
...
- 📖 [Getting Started Guide](/guides/quick-start)
- 🛡️ [Error Handling](/guides/error-handling)
- ⚡ [Performance Guide](/guides/performance)
- 🔐 [Authentication Guide](/guides/authentication)
- 📚 [Advanced Examples](/guides/advanced-examples)
