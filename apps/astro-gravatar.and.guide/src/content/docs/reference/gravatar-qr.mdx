...
/* Size Variants */
.gravatar-qr--small { width: 40px; height: 40px; }
.gravatar-qr--medium { width: 80px; height: 80px; }
.gravatar-qr--large { width: 120px; height: 120px; }
...
<img
  ...
  srcset="https://api.gravatar.com/v3/qr-code/...?size=150 1.5x,
